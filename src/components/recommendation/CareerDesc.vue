    ...
    <div class="container m-3 mx-auto">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="d-flex justify-content-end">
                    <router-link to="/Plan" custom v-slot="{ navigate }">
                        <button @click="navigate" role="link" type="button" class="btn btn-primary btn-lg">Become a Web
                            Developer</button>
                    </router-link>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                ...
                <p class="text-justify" style="padding-bottom: 30px"> Lorem ipsum dolor sit amet, consectetur adipisicing
                    elit. Aperiam quod expedita doloribus magni veritatis tempore suscipit porro, quidem consequatur
                    exercitationem neque a nulla fugiat error dignissimos adipisci voluptates? Odit, commodi. Lorem ipsum
                    dolor sit amet, consectetur adipisicing elit. Aperiam quod expedita doloribus magni veritatis tempore
                    suscipit porro, quidem consequatur exercitationem neque a nulla fugiat error dignissimos adipisci
                    voluptates? Odit, commodi </p>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mx-auto">
                ...
                <router-link to="/recommendcourses" custom v-slot="{ navigate }">
                    <div class="alert alert-primary" @click="navigate" role="alert">
